...
class GetCategoryFollowedUseCase extends UseCase<List<CategoryEntity>, NoParams> {
  final CategoryRepository _categoryRepository;

  GetCategoryFollowedUseCase(this._categoryRepository);

  @override
  Future<Either<Failure, List<CategoryEntity>>> call(NoParams params) async {
    return await _categoryRepository.getFollowed();
  }
}