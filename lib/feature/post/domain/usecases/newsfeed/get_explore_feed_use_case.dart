...
class GetExploreFeedUseCase extends UseCase<List<PostEntity>, NoParams> {
  final PostRepository _postRepository;

  GetExploreFeedUseCase(this._postRepository);

  @override
  Future<Either<Failure, List<PostEntity>>> call(NoParams params) async {
    return await _postRepository.getExploreFeed();
  }
}
