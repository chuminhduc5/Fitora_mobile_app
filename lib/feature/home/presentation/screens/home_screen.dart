...
class _HomeScreenState extends State<HomeScreen> {
  final List<Map<String, dynamic>> _articleList = [
    {
      "avatar": "https://cdn-media.sforum.vn/storage/app/media/THANHAN/avartar-anime-89.jpg",
      "author": "Chử Minh Đức",
      "title": "Chử minh đức đã cập nhật ảnh đại diện mới",
      "content": "",
      "image": "https://cdn-media.sforum.vn/storage/app/media/THANHAN/avartar-anime-89.jpg",
      "description": "",
      "time": "2 giờ trước",
      "favourite": 120,
      "comment": 50,
